...
final class APIClient {
    ...
    func uploadFaceScan(fileURL: URL, patientId: String) async throws -> UploadResponse {
        let endpoint = baseURL.appendingPathComponent("/upload-face-scan")
    ...
    private func createMultipartBody(fileURL: URL, boundary: String, fields: [String: String], fileFieldName: String, fileName: String) throws -> Data {
        var body = Data()
